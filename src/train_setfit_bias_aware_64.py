...
CHECKPOINT_DIR = Path(
    "outputs/setfit_bias_aware_64_checkpoints"
)
...
RESULTS_PATH = (
    RESULT_DIR
    / "setfit_distilroberta_64_shot_bias_aware_results.csv"
)
...
def main() -> None:
    ...
    / "few_64_shot_bias_aware.csv"
        ...
        model_path = (
    MODEL_DIR
    / "setfit_distilroberta_64_shot_bias_aware"
)
        ...
        details_path = (
    RESULT_DIR
    / "setfit_distilroberta_64_shot_bias_aware_details.json"
)
